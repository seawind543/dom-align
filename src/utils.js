...
function setLeftTop(elem, offset, option) {
    ...
    // orz // TODO: Do not need forceRelayout?
}
...
// Get border / padding / margin width
...
each(['Width', 'Height'], (name) => {
    domUtils[`doc${name}`] = (refWin) => {
        ...
        return Math.max(
            ...
            d.body[`scroll${name}`],
            domUtils[`viewport${name}`](d) // orz // TODO: Why not pass refWin but d? bug?
        );
    };
